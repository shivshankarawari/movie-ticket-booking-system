...
public class ScreenResponse {
    ...
    public ScreenResponse(long screenId, String screenName, Long seatsCapacity, List<ShowDetails> show, Theater theater, List<Seat> seat) {
    ...
    public String toString() {
        return "ScreenResponse(screenId=" + this.getScreenId() + ", screenName=" + this.getScreenName() + ", seatsCapacity=" + this.getSeatsCapacity() + ", show=" + this.getShow() + ", theater=" + this.getTheater() + ", seat=" + this.getSeat() + ")";
    }
}
