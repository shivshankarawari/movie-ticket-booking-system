...
public class ShowDetailsRequest {
    ...
    public ShowDetailsRequest(int showId, Long totalSeats, Long bookedSeats, Long availableSeats, LocalDateTime showTime, int baseTicketRate, Movie movie, Screen screen, MovieFormat movieFormat, MovieLanguage movieLanguage, List<Booking> boooking) {
        this.showId = showId;
    ...
    public String toString() {
        return "ShowDetailsRequest(showId=" + this.getShowId() + ", totalSeats=" + this.getTotalSeats() + ", bookedSeats=" + this.getBookedSeats() + ", availableSeats=" + this.getAvailableSeats() + ", showTime=" + this.getShowTime() + ", baseTicketRate=" + this.getBaseTicketRate() + ", movie=" + this.getMovie() + ", screen=" + this.getScreen() + ", movieFormat=" + this.getMovieFormat() + ", movieLanguage=" + this.getMovieLanguage() + ", boooking=" + this.getBoooking() + ")";
    }
}
